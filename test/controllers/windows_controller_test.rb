...
class WindowsControllerTest < ActionController::TestCase
  ...
  test "should create window" do
    assert_difference('Window.count') do
      post :create, window: { capacity: @window.capacity, duration: @window.duration, event_id: @window.event_id, start_time: @window.start_time }
    end
  ...
  test "should update window" do
    patch :update, id: @window, window: { capacity: @window.capacity, duration: @window.duration, event_id: @window.event_id, start_time: @window.start_time }
    assert_redirected_to window_path(assigns(:window))
  end
