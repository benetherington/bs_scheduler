class User < ActiveRecord::Base
    ...
    before_save :downcase_email #ensure emails in db are same format
    ...
    # returns true if the given token matches the stored digest (attribute defining the correct digest)
